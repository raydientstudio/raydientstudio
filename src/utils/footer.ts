...
const footerLinks = () => [
    ...
    },
    {
        ...
        links: [
            {
                name: "Publications",
                href: "https://medium.com/@rivelestudio",
                external: true,
                icon: null,
            },
    ...
    },
    {
        ...
        links: [
            ...
            {
                name: "Licensing",
                href: "/docs/end-user-license-agreement",
                external: false,
                icon: null,
            },
            {
...
const socialLinks = () => [
    {
        href: "https://www.instagram.com/rivelestudio",
        icon: IconBrandInstagram,
        label: "instagram",
    },
    {
        href: "https://www.threads.net/@rivelestudio",
        icon: IconBrandThreads,
        label: "threads",
    },
    { href: "https://x.com/rivelestudio", icon: IconBrandX, label: "x" },
    {
        href: "https://www.linkedin.com/company/rivelestudio",
        icon: IconBrandLinkedin,
        label: "linkedin",
    },
    {
        href: "https://www.facebook.com/rivelestudio",
        icon: IconBrandFacebook,
        label: "facebook",
    },
    {
        href: "https://dribbble.com/rivelestudio",
        icon: IconBrandDribbble,
        label: "dribbble",
    },
    {
        href: "https://www.behance.net/rivelestudio",
