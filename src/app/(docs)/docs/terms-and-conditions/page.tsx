                    ...
                    <div className="flex flex-col justify-start items-start w-full h-fit px-4 py-6 space-y-6">
                        <div className="flex flex-col space-y-4 mt-16">
                            ...
                            <p className="text-sm text-muted-foreground">
                                ...
                                Business Name: Rivele Studio (hereinafter referred to as “Rivele Studio,” “we,” “us,” or “our”) <br />
                                Website: <Link className="text-link hover:underline active:underline" href="https://rivelestudio.com" target="_blank" rel="noopener">rivelestudio.com</Link>
                            </p>

                            <p>
                                Please read these Terms and Conditions (“Terms”) carefully before accessing or using our website, purchasing any services, or engaging in any business with Rivele Studio. By accessing or using any part of our platform or services, you agree to be bound by these Terms. If you do not agree to all the terms and conditions, you may not access the platform or use any services.
                            </p>

                            <h3 className="text-xl font-semibold mt-6">1. Definitions</h3>
                            <ul className="list-disc list-inside space-y-1">
                                <li><strong>Services</strong> refer to design, development, branding, consultancy, or any other services offered by Rivele Studio.</li>
                                <li><strong>Client</strong> means any individual, business, or entity engaging with Rivele Studio for its services.</li>
                            ...
                            <p>
                                Email: <Link href="mailto:info@rivelestudio.com" className="text-link hover:underline active:underline">info@rivelestudio.com</Link><br />
