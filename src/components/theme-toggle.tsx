...
export function ThemeToggle() {
  ...
  return (
    <Button className="relative" type="button" role="switch" variant="outline" asIcon size="medium" aria-checked={isDark} aria-label={isDark ? "Switch to light theme" : "Switch to dark theme"} onClick={toggleTheme}>
