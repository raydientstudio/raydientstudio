				...
				<CardContent className="grid p-0 grid-cols-1 md:grid-cols-2">
					<form className="p-6 md:p-8 w-full">
						<div className="flex flex-col gap-6">
							...
							<Button type="submit" variant={"filled"} size={"wide"} radius={"small"}>
								Signup
							</Button>
							...
							<div className="grid grid-cols-3 gap-4">
								<Button aria-label={"Signup with Apple"} variant={"outlined"} size={"wide"} radius={"small"}>
								...
								<Button aria-label={"Signup with Google"} variant={"outlined"} size={"wide"} radius={"small"}>
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
										<path
								...
								<Button aria-label={"Signup with Meta"} variant={"outlined"} size={"wide"} radius={"small"}>
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
										<path
