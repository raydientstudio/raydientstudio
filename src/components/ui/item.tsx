...
const ItemTitle = ({ className, ...props }: ComponentProps<"h3">) => {
    return (
        <h3
            ...
            className={cn(
                "flex w-fit items-center gap-2 text-base text-foreground font-medium leading-relaxed",
                className
            )}
            {...props}
        >
...
const ItemDescription = ({ className, ...props }: ComponentProps<"p">) => {
    return (
        <p
            ...
            className={cn(
                "text-muted-foreground line-clamp-2 text-balance text-sm font-normal leading-relaxed",
