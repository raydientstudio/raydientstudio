...
function Search({
	...
	return (
		<CommandPrimitive
			data-slot="command"
			className={cn(
				"bg-card text-card-foreground backdrop-blur supports-backdrop-filter:bg-card/80 flex h-full w-full flex-col overflow-hidden rounded-sm",
				className
			)}
			{...props}
		/>
...
function SearchInput({
	...
	return (
		<div
			...
			className="flex flex-row h-12 items-center gap-2 border-b border-border px-3"
		>
